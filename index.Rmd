    ...
    "Athanasia Mo Mowinckel", "female",    "Norway",
      ...
      "Elizabeth M. Sweeney", "female",    "USA",
             ...
             "Jacob Maronge",   "male",    "USA",
              "Amanda Mejia", "female",    "USA",
      "Jean-Philippe Fortin",   "male",    "USA",
               "Jesper Maag",   "male",    "USA",
                 "Jian Kang",   "male",    "USA",
             "Joerg Polzehl",   "male",    "Germany",
...
1. Each package has a vignette (a tutorial/long-form documentation) and all packages have a code coverage above `r coverage_cutoff_percent`% (currently `r pct_over_50` meet this criteria).
2. We add at least 10 new packages over the course of the project and get contributions from 20 existing contributors (out of `r n_maintainers`).  Contributions will be defined as releasing updates to packages through developers GitHub repositories or submitting additional packages to the collection. 
